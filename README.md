...
5. `supabase/storage.sql` を実行（**非公開バケット** `site-photos`）
6. Authentication → Providers → Email を有効化
7. 開発時は Email confirmations を OFF 推奨（即ログイン可能）
8. Auth → Settings でパスワード最小長 8 文字を推奨
